...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| best_per_run | 0.800730 | 0.764471 | 0.779698 | 0.831913 | 6 / 6 | +0.000000 |
| shared_rank_16 | 0.801308 | 0.766205 | 0.779698 | 0.831913 | 6 / 6 | +0.002714 |
| shared_rank_512 | 1.013838 | 0.764471 | 0.817810 | 1.245425 | 5 / 6 | +1.038132 |
...
- shared `rank 512` keeps `5 / 6` tracked runs below null
- shared `rank 16` average primary relative MSE is `0.801308` versus `1.013838` for shared `rank 512`
