...
- Path: `zero_phase_iir_notch_60hz_plus_resample_1000_to_256`
...
- 60.0 Hz: group_delay=n/a, attenuation=-20.604 dB
- 80.0 Hz: group_delay=0.000000s, attenuation=-0.000 dB
- EEG burst RMSE vs resample-only: `0.000035`
- EEG average CPU ms per 63-channel window: `17.706`

## PPG cleaned path

- Path: `zero_phase_iir_notch_60hz_plus_bandpass_0p5_20hz_plus_resample_1000_to_128`
...
- 20.0 Hz: group_delay=0.000000s, attenuation=-6.004 dB
- 30.0 Hz: group_delay=0.000000s, attenuation=-23.809 dB
- 60.0 Hz: group_delay=3.921875s, attenuation=-19.574 dB
- PPG pulse rise-time error vs resample-only: `0.000000s`
- PPG pulse waveform RMSE vs resample-only: `0.039175`
- PPG average CPU ms per window: `3.819`
