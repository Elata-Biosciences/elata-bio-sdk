...
| --- | --- |
| **New app** — you will keep building from the generated `rppg-demo` scaffold | Use [rPPG In A Browser App](/guides/rppg-browser) for the integration model, then [rppg-web](/reference/rppg-web) while you change the template. For scaffold CLI details: [create-elata-demo](/reference/create-elata-demo). |
...
| Your situation | What to do next |
| --- | --- |
| **New app** — extend or respin `eeg-demo` | [EEG In A Browser App](/guides/eeg-browser), then [eeg-web](/reference/eeg-web). Scaffold reference: [create-elata-demo](/reference/create-elata-demo). |
...
| Your situation | What to do next |
| --- | --- |
| **New app** — extend `eeg-demo` via the `eeg-ble` alias path | [Web Bluetooth With Supported Devices](/guides/web-bluetooth), then [eeg-web-ble](/reference/eeg-web-ble) (and [eeg-web](/reference/eeg-web)). |
