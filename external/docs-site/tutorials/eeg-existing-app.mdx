...
Then keep calling `await initEegWasm()` as normal.

**Option 2 — pass the asset URL explicitly:**
...
This avoids the plugins but requires the `?url` import to be resolvable by your
bundler.
