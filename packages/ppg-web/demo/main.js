...
if (Symbol.dispose)
	AthenaWasmDecoder.prototype[Symbol.dispose] =
		AthenaWasmDecoder.prototype.free;
...
if (Symbol.dispose)
	AthenaWasmOutput.prototype[Symbol.dispose] = AthenaWasmOutput.prototype.free;
var EegBands = class {
	__destroy_into_raw() {
		const ptr = this.__wbg_ptr;
		this.__wbg_ptr = 0;
...
if (Symbol.dispose)
	EegBands.prototype[Symbol.dispose] = EegBands.prototype.free;
...
if (Symbol.dispose)
	WasmAlphaBumpDetector.prototype[Symbol.dispose] =
		WasmAlphaBumpDetector.prototype.free;
...
if (Symbol.dispose)
	WasmAlphaBumpResult.prototype[Symbol.dispose] =
		WasmAlphaBumpResult.prototype.free;
...
if (Symbol.dispose)
	WasmAlphaPeakModel.prototype[Symbol.dispose] =
		WasmAlphaPeakModel.prototype.free;
var WasmAlphaPeakResult = class _WasmAlphaPeakResult {
	...
	get long_term_peak_frequency() {
		const ret = wasm.wasmalphapeakresult_long_term_peak_frequency(
			this.__wbg_ptr,
		);
		return ret;
	}
	...
	get smoothed_peak_frequency() {
		const ret = wasm.wasmalphapeakresult_smoothed_peak_frequency(
			this.__wbg_ptr,
		);
		return ret;
	}
...
if (Symbol.dispose)
	WasmAlphaPeakResult.prototype[Symbol.dispose] =
		WasmAlphaPeakResult.prototype.free;
...
if (Symbol.dispose)
	WasmBandPowers.prototype[Symbol.dispose] = WasmBandPowers.prototype.free;
...
if (Symbol.dispose)
	WasmCalmnessModel.prototype[Symbol.dispose] =
		WasmCalmnessModel.prototype.free;
...
if (Symbol.dispose)
	WasmCalmnessResult.prototype[Symbol.dispose] =
		WasmCalmnessResult.prototype.free;
var WasmEegPreprocessor = class {
	...
	constructor(sample_rate_hz, channel_count, config_json) {
		var ptr0 = isLikeNone(config_json)
			? 0
			: passStringToWasm0(
					config_json,
					wasm.__wbindgen_malloc,
		...
		const ret = wasm.wasmeegpreprocessor_new(
			sample_rate_hz,
			channel_count,
			ptr0,
			len0,
	...
	update_layout(sample_rate_hz, channel_count) {
		wasm.wasmeegpreprocessor_update_layout(
			this.__wbg_ptr,
			sample_rate_hz,
			channel_count,
		);
...
if (Symbol.dispose)
	WasmEegPreprocessor.prototype[Symbol.dispose] =
		WasmEegPreprocessor.prototype.free;
...
function custom_band_power(data, sample_rate, low_freq, high_freq) {
	const ptr0 = passArrayF32ToWasm0(data, wasm.__wbindgen_malloc);
	const len0 = WASM_VECTOR_LEN;
	const ret = wasm.custom_band_power(
		ptr0,
		len0,
		sample_rate,
		low_freq,
...
var AthenaWasmDecoderFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_athenawasmdecoder_free(ptr >>> 0, 1),
			);
var AthenaWasmOutputFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_athenawasmoutput_free(ptr >>> 0, 1),
			);
var EegBandsFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) => wasm.__wbg_eegbands_free(ptr >>> 0, 1));
var WasmAlphaBumpDetectorFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmalphabumpdetector_free(ptr >>> 0, 1),
			);
var WasmAlphaBumpResultFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmalphabumpresult_free(ptr >>> 0, 1),
			);
var WasmAlphaPeakModelFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmalphapeakmodel_free(ptr >>> 0, 1),
			);
var WasmAlphaPeakResultFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmalphapeakresult_free(ptr >>> 0, 1),
			);
var WasmBandPowersFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmbandpowers_free(ptr >>> 0, 1),
			);
var WasmCalmnessModelFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmcalmnessmodel_free(ptr >>> 0, 1),
			);
var WasmCalmnessResultFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmcalmnessresult_free(ptr >>> 0, 1),
			);
var WasmEegPreprocessorFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wasmeegpreprocessor_free(ptr >>> 0, 1),
			);
	...
	processSignalBlock(block) {
		...
		return {
			...
			eegProcessing: {
				...
				detrendMode: normalizeWasmMode(inner.detrend_mode(), "highpass"),
...
var MuseBleDevice = class {
	...
	getBoardInfo() {
		...
		const isSynthetic =
			deviceName.toLowerCase().includes("synthetic") ||
	...
	async prepareSession() {
		...
		this.availableCharacteristics = characteristics.map((char) =>
		...
		for (let i = 0; i < minLen; i++) {
			rows.push(
				channelNames.map((channelName) =>
					this.ppgPerChannel[channelName].shift(),
				),
			);
		}
	...
	handlePpg(channelName, packet) {
		...
		if (channelName === "athena") {
			...
			if (optics && optics.samples.length > 0) {
				const channelCount =
					optics.channel_count || this.device.opticsChannelCount || 0;
...
function computeWaveformPeriodicityProfile(
	data,
	sampleRate,
	minBpm = BPM_MIN,
	maxBpm = BPM_MAX,
...
function designBiquad(type, sampleRate, cutoffHz, Q = BIQUAD_DEFAULT_Q) {
	const nyquistSafe = Math.max(1e-4, Math.min(cutoffHz, sampleRate / 2 - 1e-4));
...
// ../rppg-web/src/respirationAnalysis.ts
var RESP_MIN_HZ = 0.1;
var RESP_MAX_HZ = 0.6;
var RESP_MIN_BRPM = 6;
var RESP_MAX_BRPM = 34;
var CUE_NOISE_FLOOR = 0.06;
var SINGLE_CUE_FLOOR = 0.18;
var AGREE_ABS_BRPM = 2.5;
var AGREE_REL = 0.18;
var RSA_MIN_BEATS = 8;
var RSA_MIN_SPAN_SEC = 12;
var RSA_RESAMPLE_HZ = 4;
var clamp2 = (v, lo, hi) => Math.min(hi, Math.max(lo, v));
function dominantInBand(
	values,
	sampleRate,
	minHz = RESP_MIN_HZ,
	maxHz = RESP_MAX_HZ,
	...
	const confidence = clamp2((bestMag - meanMag) / (bestMag + 1e-12), 0, 1);
	return { brpm: bestHz * 60, confidence };
}
function amplitudeEnvelope(signal, sampleRate) {
	...
	const prefix = new Array(rect.length + 1).fill(0);
	for (let i = 0; i < rect.length; i++) prefix[i + 1] = prefix[i] + rect[i];
	const env = new Array(rect.length);
...
function resampleTachogram(ibisMs, beatTimesMs, resampleHz = RSA_RESAMPLE_HZ) {
	if (
...
function estimateRespiration(input) {
	...
	if (strongest.confidence >= SINGLE_CUE_FLOOR) {
		return {
			...
			confidence: clamp2(strongest.confidence * 0.85, 0, 1),
...
function analyzePulseWindow(samples) {
	...
	const respirationConfidence = respirationResult
		...
		: null;
	const skinMean =
		samples.reduce((acc, sample) => acc + clamp3(sample.skinRatio, 0, 1), 0) /
		n;
	const motionMean =
		samples.reduce((acc, sample) => acc + clamp3(sample.motion, 0, 1), 0) / n;
	const clipMean =
		samples.reduce((acc, sample) => acc + clamp3(sample.clipRatio, 0, 1), 0) /
		n;
	const quality = clamp3(
...
function estimateDominantBpm(data, sampleRate, minHz, maxHz) {
	...
	const confidence =
		energy > 1e-9 ? clamp3(bestMag / (Math.sqrt(energy) + 1e-9), 0, 1) : 0;
...
function calculateBpmViaAutocorrelation(data, fps, bpmHint) {
	...
	const build = (lag) => {
		...
		const confidence = clamp3((Math.max(0, score) * 2) / energy, 0, 1);
	...
	return {
		bpm: winning.bpm,
		confidence: clamp3(winning.confidence, 0, 1),
...
function bpmFromPeaks(peaks) {
	...
	const confidence = clamp3(1 - cov * 1.5, 0, 1);
				...
				stream.samples.push({
					...
					motion:
						prev && stream.motionScale > 0
							? clamp4(delta / (stream.motionScale * 4), 0, 1)
							: 0,
					clipRatio: 0,
				});
...
function buildCandidate(stream) {
	...
	const snrScore = clamp4(((analysis.snrDb ?? -12) + 12) / 24, 0, 1);
	const signalQuality = clamp4(
...
function stddev(values) {
	...
	const variance =
		values.reduce((acc, value) => acc + (value - mean2) ** 2, 0) /
		values.length;
...
function prepareDisplayValues(rawValues, sampleRateHz) {
	...
	return smoothed.map((value) => clamp5(value / scale, -2.2, 2.2));
}
