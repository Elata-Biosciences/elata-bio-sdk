 ...
 */
export function custom_band_power(
	data: Float32Array,
	sample_rate: number,
	low_freq: number,
	high_freq: number,
 ...
 * * `sample_rate` - Sample rate in Hz
 */
export function get_fft_frequencies(
	n: number,
	sample_rate: number,
): Float32Array;
...
export interface InitOutput {
	...
	readonly athenawasmdecoder_decode: (
		a: number,
		b: number,
		c: number,
	) => number;
	...
	readonly athenawasmdecoder_set_clock_kind: (
		a: number,
		b: number,
		c: number,
	) => void;
	readonly athenawasmdecoder_set_max_buffer_frames: (
		a: number,
		b: number,
	) => void;
	readonly athenawasmdecoder_set_reorder_window_ms: (
		a: number,
		b: number,
	) => void;
	readonly athenawasmdecoder_set_use_device_timestamps: (
		a: number,
		b: number,
	) => void;
	readonly athenawasmoutput_accgyro_samples: (a: number) => [number, number];
	readonly athenawasmoutput_accgyro_timestamps_ms: (
		a: number,
	) => [number, number];
	readonly athenawasmoutput_battery_samples: (a: number) => [number, number];
	readonly athenawasmoutput_battery_timestamps_ms: (
		a: number,
	) => [number, number];
	...
	readonly athenawasmoutput_optics_timestamps_ms: (
		a: number,
	) => [number, number];
	...
	readonly wasmalphabumpdetector_process: (
		a: number,
		b: number,
		c: number,
	) => number;
	readonly wasmalphabumpdetector_reset: (a: number) => void;
	readonly wasmalphabumpdetector_set_baseline_smoothing: (
		a: number,
		b: number,
	) => void;
	...
	readonly wasmalphapeakmodel_process: (
		a: number,
		b: number,
		c: number,
	) => number;
	...
	readonly wasmcalmnessmodel_process: (
		a: number,
		b: number,
		c: number,
	) => number;
	...
	readonly wasmcalmnessresult_state_description: (
		a: number,
	) => [number, number];
	...
	readonly wasmeegpreprocessor_new: (
		a: number,
		b: number,
		c: number,
		d: number,
	) => [number, number, number];
	readonly wasmeegpreprocessor_notch_frequencies_hz: (
		a: number,
	) => [number, number];
	readonly wasmeegpreprocessor_preserve_raw: (a: number) => number;
	readonly wasmeegpreprocessor_process: (
		a: number,
		b: number,
		c: number,
	) => [number, number];
	...
	readonly wasmeegpreprocessor_update_layout: (
		a: number,
		b: number,
		c: number,
	) => void;
