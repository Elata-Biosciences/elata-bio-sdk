...
const templates = {
	...
	"eeg-ble": {
		dir: "eeg-ble",
		description:
			"React + Vite BLE-first EEG starter app with native reference links",
	},
	"ppg-demo": {
		dir: "ppg-demo",
...
const starterChoices = [
	...
	},
	{
		...
		detail:
			"BLE-first starter with browser pairing flow and native demo references.",
	},
	{
		name: "ppg-demo",
		template: "ppg-demo",
		...
		detail:
			"Connect a Muse device and inspect BPM, RMSSD, and live PPG diagnostics.",
	},
	{
		name: "pulse-game",
		template: "pulse-game",
...
if (parentWorkspaceDir) {
	console.log(
		"Note: this app was created inside an existing pnpm workspace.\n",
	);
	console.log(
