  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        <section className="native-tools" aria-labelledby="native-tools-heading">
          ...
          <div className="native-tools-grid">
            <article className="native-card">
              ...
              <div className="native-card-paths">
                ...
                <code>ios-demo/EegDemoApp/Bluetooth/MuseBluetoothManager.swift</code>
              </div>
            </article>

            <article className="native-card">
              <p className="native-card-eyebrow">Android native BLE reference</p>
              <h3 className="native-card-title">Demo shell and Bluetooth permissions</h3>
              <p className="native-card-copy">
