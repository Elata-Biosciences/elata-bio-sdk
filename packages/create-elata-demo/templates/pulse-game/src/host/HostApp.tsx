		...
		<div className="host-shell">
			<header className="host-header">
				...
				<p className="host-subtitle">
					You are looking at the appstore shell. The boxed area below is a
					sandboxed iframe — the actual app. It talks to this shell over a
					transferred MessagePort; storage lives here, not in the app.
				</p>
				<div className="host-status">
					...
					<span>
						...
						{status === "ready" &&
							`Host ready · scope (${shorten(DEMO_WALLET_ADDRESS)}, ${APP_ID})`}
			...
			<footer className="host-footer">
				<p>
					...
					<code>createMetricsHost</code>, and call <code>host.start()</code>{" "}
					once the iframe loads. Everything else — rPPG, the game, the
					leaderboard read — happens inside the iframe.
				</p>
			</footer>
		</div>
	);
