		...
		<div className="app">
					...
					<div className="connect-group">
						{!bluetoothSupport.supported ? (
							<div className="ble-unsupported-banner" role="alert">
								<span className="ble-unsupported-icon" aria-hidden="true">
									⚠
								</span>
								<span className="ble-unsupported-msg">
			...
			<main className="main">
				<section className="stage" aria-labelledby="stage-heading">
					...
					<div className="stage-video-wrap">
						...
						<p className="stage-hint">
							3-second rolling EEG window — alpha (8–13 Hz) dominance indicates
							a relaxed state.
						</p>
					</div>
				...
				<p className="deck">
					...
					analysis, Muse BLE streaming, and a layout suited for demos and screen
					recordings.
				</p>
