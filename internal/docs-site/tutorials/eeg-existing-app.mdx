...
- the module-level guard avoids repeated initialization during normal app use
...
- You are evaluating the SDK from scratch: start with `/tutorials/first-app` instead of manual setup

## Next Steps

- Add live Muse-compatible transport: `/tutorials/eeg-ble-live-stream`
- EEG package reference: `/reference/eeg-web`
- Higher-level integration summary: `/guides/eeg-browser`
