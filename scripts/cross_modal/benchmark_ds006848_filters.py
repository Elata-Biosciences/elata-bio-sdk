#!/usr/bin/env python3
"""Benchmark distortion for the DS006848 cleaned EEG and PPG Phase 2 paths."""
...
def benchmark_frequency_rows(
    probe_freqs: list[float],
    pipeline,
    *,
    source_sfreq: int,
    target_sfreq: int,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Benchmark distortion for the DS006848 cleaned EEG and PPG paths.")
    parser.add_argument(
        "--config",
    ...
    metrics = {
        ...
        "eeg": {
            "cleaned_path": "zero_phase_iir_notch_50hz_plus_resample_1000_to_256",
        ...
        "ppg": {
            "cleaned_path": "zero_phase_iir_notch_50hz_plus_bandpass_0p5_20hz_plus_resample_1000_to_128",
