...
//!
//! 4-channel EEG with separate characteristics per channel.

/// Classic Muse characteristic UUIDs
...
/// Classic Muse device specifications
pub mod spec {
    /// Sample rate in Hz
...
/// Classic Muse uses scale factor: 256.0 / 125.0 LSB per uV
