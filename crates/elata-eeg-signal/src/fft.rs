...
mod tests {
    ...
    #[test]
    fn test_fft_zero_pads_to_next_power_of_two() {
    ...
    #[test]
    fn test_fft_frequencies_cover_nyquist() {
        let freqs = fft_frequencies(8, 256.0);
        assert_eq!(freqs, vec![0.0, 32.0, 64.0, 96.0, 128.0]);
    }
}
