...
mod tests {
    ...
    #[test]
    fn test_empty_signal_has_zero_band_power() {
        assert_eq!(band_power(&[], 256.0, bands::ALPHA), 0.0);
        assert_eq!(relative_band_power(&[], 256.0, bands::ALPHA), 0.0);

        let powers = band_powers(&[], 256.0);
